 ...
 */
  ...
  * */ 
 const pi:number = 3.14//pode ser qualquer variavel. Errado: const pi string = 78
let logado: boolean = true //se teantar qualquer outra vai da errado

//UNION TYPES: Variavel para guardar +1 valor ( | ) - avisa para o ts que vou usar dois ou mais tipos de valores 
let rg: number | string  = 1234567 //pode adicionar mais de dois, mas precisa especificar todos os tipos para pode usar 
rg = "1234567"
...
let generico: any = [] //colchetes é array
generico = {
    a: '',
    b: 8,
    c: true
...
const listaDeNome: string[] = ['João', "Maria", 'César']
listaDeNome.push('Roberta')

const num: number[] = [1,2,3,4,5]
num.push(6) //se for outro tipo não vai pegar 

const outroBoleano: boolean [] = [true, false]

//FAZER ARRAYS COM 1 OU MAIS TIPOS (Array <string|number> ) * tem que ser A maísculo = Array *
const valores: Array <string | number> = ['lenita', '25']
const numeros: Array <string> = ["lenita", 'ana', 'dengo']
const boleana: Array <boolean> = [true, false]
